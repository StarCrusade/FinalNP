...
public class OVRPlayerController : MonoBehaviour
{
    ...
    public OVRInput.Button Startpacman;
    bool PlayPac = false;


    public GameObject Snake;    
    public OVRInput.Button startSnake;
    bool PlaySnake = false;

    public GameObject SpaceInvader;
    public OVRInput.Button startSpaceInvader;
    bool PlaySpaceInvaders = false;

    public GameObject Astroids;
    public OVRInput.Button startAstroids;
    bool PlayAstroids = false;

    public GameObject BrickBreak;
    public OVRInput.Button startBrickBreak;
    bool PlayBrick = false;
	...
	void Update()
	{
        ...
        if (EnableLinearMovement == false && OVRInput.GetDown(aButton))
        {
            Debug.Log("Button pressed when needed it to");
        ...
        if (PlaySpaceInvaders == true)
        {
            PlaySpaceInvader();  
        }
        if (PlayAstroids == true)
        {
            PlayAstroid();
        }
        if(PlayBrick == true)
    ...
    void PlayPacMan()
    {
        if (OVRInput.GetDown(Startpacman) && disabled)
        {

            PacMan.SetActive(true);
            disabled = false;
        }
        else if (OVRInput.GetDown(Startpacman) && !disabled)
        {
    ...
    void PlaySnakeGame()
    {
        if (OVRInput.GetDown(startSnake) && disabled)
        {
            Snake.SetActive(true);
            disabled = false;
        }
        else if (OVRInput.GetDown(startSnake) && !disabled)
        {
    ...
    void PlaySpaceInvader()
    {
        if (OVRInput.GetDown(startSpaceInvader) && disabled)
        {
            SpaceInvader.SetActive(true);
            disabled = false;

        }
        else if (OVRInput.GetDown(startSpaceInvader) && !disabled)
        {
            SpaceInvader.SetActive(false);
            disabled = true;
        }
    }
    void PlayAstroid()
    {
        if (OVRInput.GetDown(startAstroids) && disabled)
        {
            Astroids.SetActive(true);
            disabled = false;

        }
        else if (OVRInput.GetDown(startAstroids) && !disabled)
        {
    ...
    void PlayBrickBreak()
    {
        if (OVRInput.GetDown(startBrickBreak) && disabled)
        {
            BrickBreak.SetActive(true);
            disabled = false;

        }
        else if (OVRInput.GetDown(startBrickBreak) && !disabled)
        {
